...
def get_first_page_with_selenium():
    if not os.path.exists("data_rusneb/index_with_selenium.html"):
        ...
        try:
            ...
            driver.get(
                url="https://kp.rusneb.ru/item/reader/evangelie-tetr-29")

            time.sleep(20)

            with open("data_rusneb/index_with_selenium.html", "w", encoding="utf-8") as file:
...
def get_images_links_with_selenium():
    with open("data_rusneb/index_with_selenium.html", encoding="utf-8") as file:
        src = file.read()
...
def collect_all_data(data_images_links: list):
    if not os.path.exists("data_rusneb/images_rusneb_evangelie-tetr_29"):
        os.mkdir("data_rusneb/images_rusneb_evangelie-tetr_29")

    for image_link in data_images_links[0:]:
        ...
        if req.status_code != 200:
            ...
            if not os.path.exists(f"data_rusneb/images_rusneb_evangelie-tetr_29/image_rusneb_{image_link[0]}.jpg"):

                # download_image
                with open(f"data_rusneb/images_rusneb_evangelie-tetr_29/image_rusneb_{image_link[0]}.jpg", 'wb') as file:
